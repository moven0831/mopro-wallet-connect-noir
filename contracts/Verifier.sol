...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x0fc7d23a3c1602e5ccc2cca18af25eb348b632e2cfcac118e2abe28c23b300cf),
               y: uint256(0x09330fa4b57eae13819f0009febc9e844a955086230e7bff0b30a5f90f2af697)
            }),
            qr: Honk.G1Point({ 
            ...
            qo: Honk.G1Point({ 
               x: uint256(0x0e9bf108348eaa00aa3b5f24105295340fa6dc8f8791289ab3f141a514bb70cc),
               y: uint256(0x1f2c70b3f8879c388a8554a9372eeb5296748accf06cf139817de89b340d64de)
            }),
            q4: Honk.G1Point({ 
            ...
            s1: Honk.G1Point({ 
               x: uint256(0x1849f0a83ad8c29569ada4bba6d32f0bf4b9790c0d6cbec2e90084ff0076a7be),
               y: uint256(0x1f25fd8cfc27a5d5c179162f6e28d0bd4a3fa3b0ce007b04bc202f7195593dda)
            }),
            s2: Honk.G1Point({ 
               x: uint256(0x1d9935d825f0b4b76d5d68c8d275144e9c947b4e9d6a63aac9042c9d7bdce20c),
               y: uint256(0x0a5518237997f3f04a45d136d2e8150effef35390e7d0a7e6f071f746bf4b61d)
            }),
            s3: Honk.G1Point({ 
            ...
            id2: Honk.G1Point({ 
               x: uint256(0x24988a5c5c73983e417022421ac574a48c9777822511fe2c5af2a5aee8e8cc62),
               y: uint256(0x2d17bcd38d7414cd09514b407822c47395996349fba86e2406478d24290df9f2)
            }),
            id3: Honk.G1Point({ 
