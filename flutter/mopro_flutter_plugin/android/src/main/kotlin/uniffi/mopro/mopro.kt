    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) =
            uniffiRustCall { status ->
                ...
                UniffiLib.INSTANCE.ffi_mopro_wallet_connect_noir_rustbuffer_alloc(size.toLong(), status)
            }.also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) =
            uniffiRustCall { status ->
                UniffiLib.INSTANCE.ffi_mopro_wallet_connect_noir_rustbuffer_free(buf, status)
            }
    }
...
private fun findLibraryName(componentName: String): String {
    ...
    return "mopro_wallet_connect_noir"
}
...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_mopro_wallet_connect_noir_checksum_func_combine_proof_and_public_inputs(): Short

    fun uniffi_mopro_wallet_connect_noir_checksum_func_generate_circom_proof(): Short
    ...
    fun uniffi_mopro_wallet_connect_noir_checksum_func_get_noir_verification_key(): Short

    fun uniffi_mopro_wallet_connect_noir_checksum_func_get_num_public_inputs_from_circuit(): Short

    fun uniffi_mopro_wallet_connect_noir_checksum_func_mopro_uniffi_hello_world(): Short

    fun uniffi_mopro_wallet_connect_noir_checksum_func_parse_proof_with_public_inputs(): Short
    ...
    fun ffi_mopro_wallet_connect_noir_uniffi_contract_version(): Int
}
...
internal interface UniffiLib : Library {
    ...
    // FFI functions
    fun uniffi_mopro_wallet_connect_noir_fn_func_combine_proof_and_public_inputs(
        `proof`: RustBuffer.ByValue,
        `publicInputs`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_mopro_wallet_connect_noir_fn_func_generate_circom_proof(
    ...
    fun uniffi_mopro_wallet_connect_noir_fn_func_generate_halo2_proof(
    ...
    fun uniffi_mopro_wallet_connect_noir_fn_func_get_noir_verification_key(
        `circuitPath`: RustBuffer.ByValue,
        `srsPath`: RustBuffer.ByValue,
        `onChain`: Byte,
        `lowMemoryMode`: Byte,
    ...
    fun uniffi_mopro_wallet_connect_noir_fn_func_get_num_public_inputs_from_circuit(
        `circuitPath`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun uniffi_mopro_wallet_connect_noir_fn_func_mopro_uniffi_hello_world(uniffi_out_err: UniffiRustCallStatus): RustBuffer.ByValue

    fun uniffi_mopro_wallet_connect_noir_fn_func_parse_proof_with_public_inputs(
        `proof`: RustBuffer.ByValue,
        `numPublicInputs`: Int,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_mopro_wallet_connect_noir_fn_func_verify_circom_proof(
        `zkeyPath`: RustBuffer.ByValue,
    ...
    fun uniffi_mopro_wallet_connect_noir_fn_func_verify_halo2_proof(
        `srsPath`: RustBuffer.ByValue,
    ...
    fun ffi_mopro_wallet_connect_noir_rustbuffer_alloc(
        `size`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_wallet_connect_noir_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_wallet_connect_noir_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_u8(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_u8(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_u8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_i8(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_i8(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_i8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_u16(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_u16(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_u16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_i16(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_i16(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_i16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_u32(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_u32(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_u32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_i32(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_i32(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_i32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_u64(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_u64(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_u64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_i64(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_i64(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_i64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_f32(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_f32(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_f32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Float

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_f64(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_f64(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_f64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Double

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_pointer(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_pointer(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_pointer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_rust_buffer(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_rust_buffer(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_wallet_connect_noir_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_cancel_void(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_free_void(`handle`: Long): Unit

    fun ffi_mopro_wallet_connect_noir_rust_future_complete_void(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
}
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_mopro_wallet_connect_noir_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_combine_proof_and_public_inputs() != 1877.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_generate_circom_proof() != 34456.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_generate_halo2_proof() != 32033.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_generate_noir_proof() != 22341.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_get_noir_verification_key() != 39944.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_get_num_public_inputs_from_circuit() != 8643.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_mopro_uniffi_hello_world() != 53178.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_parse_proof_with_public_inputs() != 39945.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_verify_circom_proof() != 47338.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_verify_halo2_proof() != 56166.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_wallet_connect_noir_checksum_func_verify_noir_proof() != 4760.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
 ...
 */
data class ProofWithPublicInputs(
    /**
     ...
     */
    var `publicInputs`: List<kotlin.ByteArray>,
    /**
 ...
 * @suppress
 */
public object FfiConverterTypeProofWithPublicInputs : FfiConverterRustBuffer<ProofWithPublicInputs> {
    override fun read(buf: ByteBuffer): ProofWithPublicInputs =
    ...
    override fun allocationSize(value: ProofWithPublicInputs) =
        (
            FfiConverterByteArray.allocationSize(value.`proof`) +
                FfiConverterSequenceByteArray.allocationSize(value.`publicInputs`) +
                FfiConverterUInt.allocationSize(value.`numPublicInputs`)
        )

    override fun write(
        value: ProofWithPublicInputs,
        buf: ByteBuffer,
    ) {
        FfiConverterByteArray.write(value.`proof`, buf)
        FfiConverterSequenceByteArray.write(value.`publicInputs`, buf)
 ...
 */
fun `combineProofAndPublicInputs`(
    `proof`: kotlin.ByteArray,
    `publicInputs`: List<kotlin.ByteArray>,
): kotlin.ByteArray =
    FfiConverterByteArray.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_combine_proof_and_public_inputs(
                FfiConverterByteArray.lower(`proof`),
                FfiConverterSequenceByteArray.lower(`publicInputs`),
                _status,
            )
        },
    )
...
fun `generateCircomProof`(
    ...
    FfiConverterTypeCircomProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_generate_circom_proof(
...
fun `generateHalo2Proof`(
    ...
    FfiConverterTypeHalo2ProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_generate_halo2_proof(
...
fun `generateNoirProof`(
    ...
    FfiConverterByteArray.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_generate_noir_proof(
...
fun `getNoirVerificationKey`(
    ...
    FfiConverterByteArray.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_get_noir_verification_key(
                FfiConverterString.lower(`circuitPath`),
                FfiConverterOptionalString.lower(`srsPath`),
                FfiConverterBoolean.lower(`onChain`),
                FfiConverterBoolean.lower(`lowMemoryMode`),
 ...
 */
fun `getNumPublicInputsFromCircuit`(`circuitPath`: kotlin.String): kotlin.UInt =
    FfiConverterUInt.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_get_num_public_inputs_from_circuit(
                FfiConverterString.lower(`circuitPath`),
                _status,
            )
        },
...
fun `moproUniffiHelloWorld`(): kotlin.String =
    FfiConverterString.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_mopro_uniffi_hello_world(_status)
        },
    )
 ...
 */
fun `parseProofWithPublicInputs`(
    `proof`: kotlin.ByteArray,
    `numPublicInputs`: kotlin.UInt,
): ProofWithPublicInputs =
    FfiConverterTypeProofWithPublicInputs.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_parse_proof_with_public_inputs(
                FfiConverterByteArray.lower(`proof`),
                FfiConverterUInt.lower(`numPublicInputs`),
                _status,
            )
        },
    )
...
fun `verifyCircomProof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_verify_circom_proof(
                FfiConverterString.lower(`zkeyPath`),
...
fun `verifyHalo2Proof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_wallet_connect_noir_fn_func_verify_halo2_proof(
                FfiConverterString.lower(`srsPath`),
